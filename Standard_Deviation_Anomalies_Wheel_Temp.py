...
def detect_anomalies_with_mean(ts, num_stds, verbose):
    """Detect outliers in the wheel temperature data by comparing points against [num_stds] standard deviations from the mean.
       ...
       Example:
           wheel_temp_with_outliers, outliers = detect_anomalies_with_mean(time_series, 2, True)
       """
...
def detect_anomalies_with_rolling_mean(ts, num_stds, window, verbose):
    """Detect outliers in the wheel temperature data by comparing points against [num_stds] standard deviations from a rolling mean.
       ...
       Example:
           wheel_temp_with_outliers, outliers = detect_anomalies_with_rolling_mean(time_series, 2, window, False)
    """
...
if __name__ == "__main__":
    ...
    wheel_temp_with_outliers = standard_deviation_anomalies_wheel_temp(verbose=True, use_rolling_mean=True,
