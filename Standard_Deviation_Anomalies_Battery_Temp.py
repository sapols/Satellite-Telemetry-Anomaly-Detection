...
def standard_deviation_anomalies_battery_temp(dataset_path='Data/BatteryTemperature.csv',
                                              plots_save_path=None, verbose=False):
    """Detect outliers in the battery temperature data by comparing points against two standard deviations from the mean.
...
if __name__ == "__main__":
    ...
    battery_temp_with_outliers = standard_deviation_anomalies_battery_temp(verbose=True)
